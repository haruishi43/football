...
class FootballActionSetTest(absltest.TestCase):
    def test_action_from_basic_action_set(self):
        ...
        self.assertEqual(
            named_action_from_action_set(action_set, 1), football_action_set.action_left
        )
        self.assertEqual(
        ...
        self.assertEqual(
            named_action_from_action_set(action_set, np.int32(1)),
            football_action_set.action_left,
        )
        self.assertRaises(
            Exception, named_action_from_action_set, action_set, np.int32(100)
        )

        self.assertEqual(
            named_action_from_action_set(action_set, football_action_set.action_left),
            football_action_set.action_left,
        )
    ...
    def test_disable_action(self):
        self.assertEqual(
            football_action_set.disable_action(football_action_set.action_left),
